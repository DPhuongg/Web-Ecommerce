    ...
    <div class="order bg-[#EFEFEF] p-9">
      ...
      <div class="mb-8 flex justify-between">
        <div class="mb-8 flex">
          ...
          <button @click="handleSearch" class="button text-[15px] ml-[80px] text-[#fff] bg-[#69C3A3] p-2 font-medium rounded-lg px-4">
            Tìm kiếm
          </button>
        </div>
      </div>
...
import { EditIcon, TrashIcon } from '@/assets/icons/icon.js';
